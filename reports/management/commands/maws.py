...
from reports.models import PostReport, GidroPost
from os import walk
...
class Command(BaseCommand):
    ...
    def get_fils(self)->List[str]:
        ...
        for (dirpath, dirnames, filenames) in walk("C:/Data_of_posts/"):
            ...
            break
        return file_report
    def pars_file(self, file_name:str)->PostReport:
        ...
        return PostReport(post=post,report_time=repdata,
                          report_type=PostReport.ReportType.MAWS,
